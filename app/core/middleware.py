...
class ServiceUnavailableMiddleware:
    """Answers 503 instead of 500 when a dependency is missing.

    The difference is not cosmetic: 500 says the code is broken and the request
    is pointless to repeat, 503 says the site is fine and to come back shortly.
    Search engines and monitoring read them that way too.
    """
